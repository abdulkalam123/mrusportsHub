 ...
 * Generated at: 2024-06-03 06:40:00 UTC
...
public final class Selected_002dvolleyball_002dteam_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <h1>Volleyball Teams</h1>\r\n");
      out.write("        \r\n");
      ...
      out.write("                    ");
                    ...
                    try {
                        ...
                        String sql = "SELECT team_name, player_name, player_position FROM selectedvolleyballteam WHERE team_type = 'Your Team' AND match_id = ?";
      ...
      out.write("                    ");
                    ...
                    try {
                        conn = DriverManager.getConnection(dbURL, dbUser, dbPassword);
                        int matchId = Integer.parseInt(request.getParameter("match_id"));
                        String sql = "SELECT team_name, player_name, player_position FROM selectedvolleyballteam WHERE team_type = 'Opposite Team' AND match_id = ?";
                        stmt = conn.prepareStatement(sql);
                        stmt.setInt(1, matchId);
                        rs = stmt.executeQuery();
